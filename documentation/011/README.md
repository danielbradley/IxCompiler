...
IxSourceMethod* IxSourceMethod_new();
...
```c/ixcompiler.IxSourceUnitCollection.c
void IxSourceUnitCollection_add( IxSourceUnitCollection* self, IxSourceUnit** sourceFile )
{
    ArrayOfString_union( self->copyrightLines, IxSourceUnit_getCopyrightLines( *sourceFile ) );
    ArrayOfString_union( self->licenseLines,   IxSourceUnit_getLicenseLines  ( *sourceFile ) );
...
ArrayOfString* IxSourceUnitCollection_retrieveTypes( const IxSourceUnitCollection* self )
{
    ArrayOfString* types = ArrayOfString_new();
    {
        ...
        for ( int i=0; i < n; i++ )
        {
            ...
            const String*       name = IxSourceUnit_getName( unit );

            tmp = String_copy( name );
            ArrayOfString_push( types, &tmp );
        }
    }
    return types;
}
...
StringBuffer* StringBuffer_appendLine ( StringBuffer*  self, char* prefix, String* string );
...
```c/ixcompiler.StringBuffer.c
StringBuffer* StringBuffer_appendLine ( StringBuffer*  self, char* prefix, String* optional_string )
{
...
```!include/ixcompiler.Take.h
#ifndef IXCOMPILER_TAKE_H
#define IXCOMPILER_TAKE_H
